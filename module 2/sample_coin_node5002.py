...
def mine_block():
    ...
    blockchain.add_transaction(sender=node_address, receiver='Stranger', amount=0.01)
...
def connect_node():
    ...
    response = {'message': 'All the nodes are connected. The sample_coin blockchain now contains teh :',
